...
function About() {
  return (
    <div>
      <h1>Cooper Healey</h1>
      <p>As a native North Carolinian, I enjoy new challenges and helping people in the Raleigh/Durham/Chapel Hill areas.
      ...
      <p>Phone: 919-414-2878</p>
      <p>Email: coophealey@gmail.com</p>
    </div>
  );
}
